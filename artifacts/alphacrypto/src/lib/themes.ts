...
export const THEMES: Theme[] = [
  ...
  // ── 2. SILVER ──────────────────────────────────────────────────────────────
  {
    ...
    vars: {
      ...
      "--input": "220 14% 24%",
      "--ring": "210 20% 75%",
      "--gradient-hero": "radial-gradient(ellipse at top, hsl(215 25% 28%) 0%, hsl(220 20% 14%) 55%, hsl(220 18% 8%) 85%)",
  ...
  // ── 3. DARK CYAN ───────────────────────────────────────────────────────────
  {
    ...
    vars: {
      ...
      "--input": "188 48% 22%",
      "--ring": "187 100% 55%",
      "--gradient-hero": "radial-gradient(ellipse at top, hsl(187 95% 32%) 0%, hsl(200 85% 22%) 45%, hsl(188 70% 7%) 80%)",
  ...
  // ── 4. DARK MAGENTA ────────────────────────────────────────────────────────
  {
    ...
    vars: {
      ...
      "--input": "302 42% 22%",
      "--ring": "300 100% 58%",
      "--gradient-hero": "radial-gradient(ellipse at top, hsl(300 95% 35%) 0%, hsl(320 85% 28%) 45%, hsl(302 65% 7%) 80%)",
  ...
  // ── 5. DARK GREEN ──────────────────────────────────────────────────────────
  {
    ...
    vars: {
      ...
      "--input": "140 45% 21%",
      "--ring": "138 100% 48%",
      "--gradient-hero": "radial-gradient(ellipse at top, hsl(138 90% 28%) 0%, hsl(155 80% 22%) 45%, hsl(140 65% 6%) 80%)",
  ...
  // ── 6. DARK ORANGE ─────────────────────────────────────────────────────────
  {
    ...
    vars: {
      ...
      "--input": "24 52% 21%",
      "--ring": "28 100% 58%",
      "--gradient-hero": "radial-gradient(ellipse at top, hsl(28 100% 38%) 0%, hsl(12 95% 28%) 45%, hsl(24 80% 6%) 80%)",
  ...
  // ── 7. DARK BLUE ───────────────────────────────────────────────────────────
  {
    ...
    vars: {
      ...
      "--input": "236 52% 22%",
      "--ring": "224 100% 65%",
      "--gradient-hero": "radial-gradient(ellipse at top, hsl(224 100% 38%) 0%, hsl(248 90% 30%) 45%, hsl(236 75% 7%) 80%)",
  ...
  // ── 8. DARK RED ────────────────────────────────────────────────────────────
  {
    ...
    vars: {
      ...
      "--input": "0 46% 21%",
      "--ring": "0 100% 62%",
      "--gradient-hero": "radial-gradient(ellipse at top, hsl(0 95% 35%) 0%, hsl(18 88% 28%) 45%, hsl(0 70% 6%) 80%)",
