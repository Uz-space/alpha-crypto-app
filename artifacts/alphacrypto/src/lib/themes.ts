...
export const THEMES: Theme[] = [
  // ── 1. MONO (default) ──────────────────────────────────────────────────────
  {
    ...
    vars: {
      ...
      "--input": "0 0% 14%",
      "--ring": "0 0% 80%",
      "--gradient-hero": "linear-gradient(180deg, hsl(0 0% 12%) 0%, hsl(0 0% 4%) 100%)",
  ...
  // ── 2. SILVER ──────────────────────────────────────────────────────────────
  {
    ...
    vars: {
      ...
      "--input": "220 14% 24%",
      "--ring": "210 20% 75%",
      "--gradient-hero": "linear-gradient(180deg, hsl(215 25% 18%) 0%, hsl(220 18% 8%) 100%)",
  ...
  // ── 3. DARK CYAN ───────────────────────────────────────────────────────────
  {
    ...
    vars: {
      ...
      "--input": "188 48% 22%",
      "--ring": "187 100% 55%",
      "--gradient-hero": "linear-gradient(180deg, hsl(187 80% 16%) 0%, hsl(188 70% 7%) 100%)",
  ...
  // ── 4. DARK MAGENTA ────────────────────────────────────────────────────────
  {
    ...
    vars: {
      ...
      "--input": "302 42% 22%",
      "--ring": "300 100% 58%",
      "--gradient-hero": "linear-gradient(180deg, hsl(300 80% 16%) 0%, hsl(302 65% 7%) 100%)",
  ...
  // ── 5. DARK GREEN ──────────────────────────────────────────────────────────
  {
    ...
    vars: {
      ...
      "--input": "140 45% 21%",
      "--ring": "138 100% 48%",
      "--gradient-hero": "linear-gradient(180deg, hsl(138 75% 14%) 0%, hsl(140 65% 6%) 100%)",
  ...
  // ── 6. DARK ORANGE ─────────────────────────────────────────────────────────
  {
    ...
    vars: {
      ...
      "--input": "24 52% 21%",
      "--ring": "28 100% 58%",
      "--gradient-hero": "linear-gradient(180deg, hsl(28 90% 18%) 0%, hsl(24 80% 6%) 100%)",
  ...
  // ── 7. DARK BLUE ───────────────────────────────────────────────────────────
  {
    ...
    vars: {
      ...
      "--input": "236 52% 22%",
      "--ring": "224 100% 65%",
      "--gradient-hero": "linear-gradient(180deg, hsl(224 85% 18%) 0%, hsl(224 75% 7%) 100%)",
  ...
  // ── 8. DARK RED ────────────────────────────────────────────────────────────
  {
    ...
    vars: {
      ...
      "--input": "0 46% 21%",
      "--ring": "0 100% 62%",
      "--gradient-hero": "linear-gradient(180deg, hsl(0 80% 16%) 0%, hsl(0 70% 6%) 100%)",
