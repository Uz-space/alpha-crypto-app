        ...
        <header className="grid grid-cols-3 items-center pb-4 gap-3">
          <div className="flex items-center gap-2 relative z-10">
            <button
              ...
              aria-label="Shield"
              className="relative h-[38px] w-[38px] rounded-full bg-foreground flex items-center justify-center select-none touch-none"
          ...
          <div className="flex items-center gap-2 justify-end relative z-10">
            <Link
              to="/exchange"
              aria-label="Exchange"
              className="h-[38px] w-[38px] rounded-full bg-foreground flex items-center justify-center transition"
            >
