...
export const THEMES: Theme[] = [
  ...
  // ── 3. DARK CYAN ───────────────────────────────────────────────────────────
  {
    ...
    vars: {
      ...
      "--input": "188 48% 22%",
      "--ring": "187 100% 55%",
      "--gradient-hero": "radial-gradient(ellipse at top, hsl(187 95% 30%) 0%, hsl(187 80% 16%) 50%, hsl(188 70% 7%) 85%)",
  ...
  // ── 4. DARK MAGENTA ────────────────────────────────────────────────────────
  {
    ...
    vars: {
      ...
      "--input": "302 42% 22%",
      "--ring": "300 100% 58%",
      "--gradient-hero": "radial-gradient(ellipse at top, hsl(300 95% 32%) 0%, hsl(300 80% 16%) 50%, hsl(302 65% 7%) 85%)",
  ...
  // ── 5. DARK GREEN ──────────────────────────────────────────────────────────
  {
    ...
    vars: {
      ...
      "--input": "140 45% 21%",
      "--ring": "138 100% 48%",
      "--gradient-hero": "radial-gradient(ellipse at top, hsl(138 90% 26%) 0%, hsl(138 75% 14%) 50%, hsl(140 65% 6%) 85%)",
  ...
  // ── 6. DARK ORANGE ─────────────────────────────────────────────────────────
  {
    ...
    vars: {
      ...
      "--input": "24 52% 21%",
      "--ring": "28 100% 58%",
      "--gradient-hero": "radial-gradient(ellipse at top, hsl(28 100% 35%) 0%, hsl(28 85% 18%) 50%, hsl(24 80% 6%) 85%)",
  ...
  // ── 7. DARK BLUE ───────────────────────────────────────────────────────────
  {
    ...
    vars: {
      ...
      "--input": "236 52% 22%",
      "--ring": "224 100% 65%",
      "--gradient-hero": "radial-gradient(ellipse at top, hsl(224 100% 35%) 0%, hsl(224 85% 18%) 50%, hsl(236 75% 7%) 85%)",
  ...
  // ── 8. DARK RED ────────────────────────────────────────────────────────────
  {
    ...
    vars: {
      ...
      "--input": "0 46% 21%",
      "--ring": "0 100% 62%",
      "--gradient-hero": "radial-gradient(ellipse at top, hsl(0 95% 32%) 0%, hsl(0 80% 16%) 50%, hsl(0 70% 6%) 85%)",
