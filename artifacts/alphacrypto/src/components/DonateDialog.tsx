    ...
    <Dialog>
      <DialogTrigger asChild>
        <motion.button
          ...
          title="Yordam berish"
          className="group relative inline-flex items-center justify-center h-10 w-10 rounded-full bg-foreground text-background shadow-glow transition-shadow hover:shadow-[0_0_30px_hsl(0_0%_100%/0.3)]"
        >
